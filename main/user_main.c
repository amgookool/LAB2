...
void app_main(void)
{
    ...
    {
        // LED task functions
        xTaskCreate(led_on, "led_on_task", 2048, NULL, MEDIUM_PRIORITY, NULL);
        xTaskCreate(led_off, "led_off_task", 2048, NULL, LOW_PRIORITY, NULL);
    }

    // Status Message task function 
    xTaskCreate(status_message, "status_message_task", 2048, NULL, HIGH_PRIORITY, NULL);
